...
ActiveRecord::Schema[7.1].define(version: 2024_07_24_012043) do
  ...
  create_table "active_storage_blobs", charset: "utf8mb4", collation: "utf8mb4_ja_0900_as_cs_ks", force: :cascade do |t|
  ...
  create_table "active_storage_variant_records", charset: "utf8mb4", collation: "utf8mb4_ja_0900_as_cs_ks", force: :cascade do |t|
    t.bigint "blob_id", null: false
